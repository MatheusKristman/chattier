...
import { infoContainerAnimation, infoAnimation } from "@/constants/framer-animation/register-form";
...
const registerFormSchema = z
    .object({
        ...
        passwordConfirm: z
            ...
            .min(8, { message: "Confirmação de senha precisa ter no mínimo 8 caracteres" }),
            ...
            >
                ...
                <Form {...form}>
                    ...
                    >
                        ...
                        <Button type="submit" className="w-full py-2 bg-white rounded-[30px]">
