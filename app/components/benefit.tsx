        ...
        <section className="w-full pt-24 px-6 flex flex-col gap-y-24 md:px-16 lg:mx-auto lg:container lg:flex-row-reverse">
            ...
            >
                <motion.h2
                    ...
                    className="relative text-white text-3xl font-bold leading-[42px] ml-10 max-w-sm before:content-[''] before:bg-benefit-blob before:bg-no-repeat before:bg-contain before:absolute before:-top-10 before:-left-10 before:w-72 before:h-56 before:-z-10 md:text-4xl md:leading-[54px] md:max-w-xl"
                >
